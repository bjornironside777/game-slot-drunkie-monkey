import { AnimatedSprite, Container, DisplayObject, IDestroyOptions, Point, Sprite, Texture } from 'pixi.js';
...
export default class SymbolView extends Container {
    ...
    protected destroyAnimation: Spine;
    ...
    constructor(data: SymbolData) {
        ...
        if(data.destroyAnimation) {
            this.destroyAnimation = new Spine(AssetsManager.spine.get(data.destroyAnimation.spineAssetName));
